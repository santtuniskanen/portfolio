...
import SalaLogo from "../public/assets/logo/aries.svg";
...
const Navbar = () => {
  ...
  const [navBg, setNavBg] = useState("#ecf0f3"); // Sets a background for nav
  ...
  useEffect(() => {
    if (
      router.asPath === "/vahti" ||
      router.asPath === "/banksimul" ||
      router.asPath === "/devopsproject" ||
      router.asPath === "/stardewmod"
    ) {
  ...
  return (
    ...
    >
      <div className="flex pt-6 justify-center items-center w-full px-2 2xl:px-16">
        <div>
